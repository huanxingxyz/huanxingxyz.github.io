...
public class QuotePriceResDto extends BaseResDto {
    ...
    private List<CoverageDataDto> coverageList = new ArrayList<CoverageDataDto>();
    ...
    public void setCoverageList(List<CoverageDataDto> coverageList) {
